...
class ReplicationProcessFullIndexAndTaxo extends ReplicationProcessFullIndex {

	private final ReplicationProcessFullIndex taxoReplicationProcess;

	ReplicationProcessFullIndexAndTaxo(final Path workDirectory, final Path indexDirectoryPath,
		...
		taxoReplicationProcess =
				new ReplicationProcessFullIndex(workDirectory, taxoDirectoryPath, taxoDirectory, Source.taxo,
