...
public class IndexUtils {
	...
	private final static void fieldCollection(final PerFieldAnalyzer.AnalyzerContext context,
					final Map<String, Object> document, final Consumer<Field> consumer) throws IOException {
	...
	private final static Document newLuceneDocument(final PerFieldAnalyzer.AnalyzerContext context,
	...
	static final Object addNewLuceneDocument(final PerFieldAnalyzer.AnalyzerContext context,
					final Map<String, Object> document, IndexWriter indexWriter) throws IOException {
	...
	private static final Field[] newFieldList(final PerFieldAnalyzer.AnalyzerContext context,
					final Map<String, Object> document) throws IOException {
	...
	static final void updateDocValues(final PerFieldAnalyzer.AnalyzerContext context,
					final Map<String, Object> document, IndexWriter indexWriter) throws ServerException, IOException {
		Object id = document.get(IndexUtils.FIELD_ID);
		if (id == null)
