...
class SortedIntDocValuesType implements FieldTypeInterface {

	SortedIntDocValuesType() {
		super();
	}
	...
	final public void fillDocument(final String fieldName, final Object value, Document doc) {
		if (value instanceof Collection)
			...
			doc.add(new SortedNumericDocValuesField(fieldName, ((Number) value).intValue()));
		else
			doc.add(new SortedNumericDocValuesField(fieldName, Integer.parseInt(value.toString())));
	}
