...
class SortedSetDocValuesFacetType implements FieldTypeInterface {

	SortedSetDocValuesFacetType() {
		super();
	}
	...
	final public void fillDocument(final String fieldName, final Object value, Document doc) {
		if (value instanceof Collection)
			...
			doc.add(new SortedSetDocValuesFacetField(fieldName, value.toString()));
	}
