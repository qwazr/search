...
public class MoreLikeThis extends AbstractQuery<MoreLikeThis> {
    ...
    private MoreLikeThis(final Builder builder) {
        super(MoreLikeThis.class);
    ...
    @Override
    protected boolean isEqual(MoreLikeThis q) {
    ...
    final public Query getQuery(final QueryContext queryContext) throws IOException, ParseException {
        ...
        final org.apache.lucene.queries.mlt.MoreLikeThis mlt = new org.apache.lucene.queries.mlt.MoreLikeThis(queryContext.getIndexReader());
        if (is_boost != null)
