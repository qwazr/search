...
public class TextTermQuery extends AbstractQuery {

	final public String field;
	final public String text;
	final public Boolean apply_analyzer;

	public TextTermQuery() {
		super(null);
		field = null;
		text = null;
		apply_analyzer = null;
	...
	public TextTermQuery(String field, String text) {
		super(null);
		this.field = field;
		this.text = text;
	...
	public TextTermQuery(Float boost, String field, String text) {
		super(boost);
		this.field = field;
		this.text = text;
		this.apply_analyzer = null;
	...
	public TextTermQuery(Float boost, String field, String text, Boolean apply_analyzer) {
		super(boost);
		this.field = field;
		this.text = text;
