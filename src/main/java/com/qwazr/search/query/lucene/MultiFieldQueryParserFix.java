...
public class MultiFieldQueryParserFix extends MultiFieldQueryParser {

	public MultiFieldQueryParserFix(String[] fields, Analyzer analyzer, Map<String, Float> boosts) {
