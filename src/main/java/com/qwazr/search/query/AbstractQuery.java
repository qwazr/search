...
@JsonSubTypes({ @JsonSubTypes.Type(value = BooleanQuery.class), @JsonSubTypes.Type(value = BoostedQuery.class),
				...
				@JsonSubTypes.Type(value = DisjunctionMaxQuery.class), @JsonSubTypes.Type(value = DrillDownQuery.class),
				@JsonSubTypes.Type(value = CustomScoreQuery.class), @JsonSubTypes.Type(value = FacetPathQuery.class),
