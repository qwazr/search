...
type DoError = (error: string) => void;
type DoJson = (json: any) => void;
type DoText = (text: string) => void;
 ...
 */
export function fetchJson(request: RequestInfo,
...
export function simpleFetch(request: RequestInfo,
                            init: RequestInit | undefined,
                            doOk: DoText,
                            doError: DoError) {
  if (!doError)
