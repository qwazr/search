...
public class BooleanCollectionSetterTest extends AbstractCollectionSetterTest<Boolean> {
	...
	public BooleanCollectionSetterTest() throws NoSuchFieldException {
		super(new BooleanCollectionSetterImpl(AbstractCollectionSetterTest.class.getDeclaredField("value")));
	}
	...
	protected void checkValueString(String... values) {
		...
		int i = 0;
		for (Boolean v : value)
			Assert.assertEquals(v, Boolean.parseBoolean(values[i++]));
	}
