...
public class LongPrimitiveSetterTest extends AbstractSingleSetterTest {

	long value;

	public LongPrimitiveSetterTest() throws NoSuchFieldException {
		super(new LongPrimitiveSetterImpl(LongPrimitiveSetterTest.class.getDeclaredField("value")));
	}
	...
	protected void checkValueString(String next) {
		Assert.assertEquals(Long.parseLong(next), value, 0);
	}
