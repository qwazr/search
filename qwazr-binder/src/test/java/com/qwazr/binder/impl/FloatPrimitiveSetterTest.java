...
public class FloatPrimitiveSetterTest extends AbstractSingleSetterTest {
	...
	public FloatPrimitiveSetterTest() throws NoSuchFieldException {
		super(new FloatPrimitiveSetterImpl(FloatPrimitiveSetterTest.class.getDeclaredField("value")));
	}
	...
	protected void checkValueString(String next) {
		Assert.assertEquals(Float.parseFloat(next), value, 0);
	}
	...
	protected void checkValueNull() {
		Assert.assertEquals(Float.NaN, value, 0);
	}
}
