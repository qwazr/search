...
public class IntegerCollectionSetterTest extends AbstractCollectionSetterTest<Integer> {
	...
	public IntegerCollectionSetterTest() throws NoSuchFieldException {
		super(new IntegerCollectionSetterImpl(AbstractCollectionSetterTest.class.getDeclaredField("value")));
	}
	...
	protected void checkValueString(String... values) {
		...
		int i = 0;
		for (Integer v : value)
			Assert.assertEquals(v, Integer.parseInt(values[i++]), 0);
	}
