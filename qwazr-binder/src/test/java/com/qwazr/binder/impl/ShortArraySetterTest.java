...
public class ShortArraySetterTest extends AbstractArraySetterTest<Short> {

	public ShortArraySetterTest() throws NoSuchFieldException {
		super(new ShortArraySetterImpl(AbstractArraySetterTest.class.getDeclaredField("value")));
	}
	...
	protected void checkValueString(String... values) {
		...
		int i = 0;
		for (String v : values)
			Assert.assertEquals(Short.parseShort(v), get(i++), 0);
	}
