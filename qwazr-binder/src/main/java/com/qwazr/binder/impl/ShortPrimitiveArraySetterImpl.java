...
final public class ShortPrimitiveArraySetterImpl extends PrimitiveArraySetterAbstract {

	public ShortPrimitiveArraySetterImpl(Field field) {
		super(field);
	}

	@Override
	public void fromString(String value, Object object) {
		set(object, new short[] { Short.parseShort(value) });
	}

	@Override
	final protected void fromNumber(Number number, Object object) {
		set(object, new short[] { number.shortValue() });
	}

	@Override
	public void fromChar(Character value, Object object) {
		set(object, new short[] { (short) (int) value });
	}

	@Override
	public void fromBoolean(Boolean value, Object object) {
		set(object, new short[] { (short) (value ? 1 : 0) });
	}

	@Override
	public void fromDouble(double value, Object object) {
		set(object, new short[] { (short) value });
	}
