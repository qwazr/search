...
final public class DoublePrimitiveArraySetterImpl extends PrimitiveArraySetterAbstract {

	public DoublePrimitiveArraySetterImpl(Field field) {
		super(field);
	}

	@Override
	public void fromString(String value, Object object) {
		set(object, new double[] { Double.parseDouble(value) });
	}

	@Override
	final protected void fromNumber(Number number, Object object) {
		set(object, new double[] { number.doubleValue() });
	}

	@Override
	public void fromChar(Character value, Object object) {
		set(object, new double[] { (double) value });
	}

	@Override
	public void fromBoolean(Boolean value, Object object) {
		set(object, new double[] { (double) (value ? 1 : 0) });
	}

	@Override
	public void fromDouble(double value, Object object) {
		set(object, new double[] { value });
	}
