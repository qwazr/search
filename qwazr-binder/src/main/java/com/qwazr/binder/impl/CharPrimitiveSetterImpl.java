...
final public class CharPrimitiveSetterImpl extends ObjectSetterAbstract {

	public CharPrimitiveSetterImpl(Field field) {
		super(field);
	}

	@Override
	public void fromNull(Object object) {
		setChar(object, (char) 0);
	}
	...
	public void fromDouble(Double value, Object object) {
		setChar(object, (char) value.intValue());
	}
