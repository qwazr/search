...
final public class IntegerSetterImpl extends ObjectSetterAbstract {

	public IntegerSetterImpl(Field field) {
		super(field);
	}

	@Override
	public void fromString(String value, Object object) {
		set(object, Integer.parseInt(value));
	}
