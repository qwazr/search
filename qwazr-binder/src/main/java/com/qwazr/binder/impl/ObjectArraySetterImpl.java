...
final public class ObjectArraySetterImpl extends ArraySetterAbstract<Object> {

	public ObjectArraySetterImpl(Field field) {
		super(field);
	}
	...
	@Override
	protected Object fromInteger(Integer value) {
		return value;
	}
