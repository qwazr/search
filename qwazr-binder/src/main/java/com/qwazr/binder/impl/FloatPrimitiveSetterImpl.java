...
final public class FloatPrimitiveSetterImpl extends ObjectSetterAbstract {

	public FloatPrimitiveSetterImpl(Field field) {
		super(field);
	}

	@Override
	public void fromNull(Object object) {
		setFloat(object, Float.NaN);
	}

	@Override
	public void fromString(String value, Object object) {
		setDouble(object, Float.parseFloat(value));
	}

	@Override
	public void fromDouble(Double value, Object object) {
		setFloat(object, value.floatValue());
	}
