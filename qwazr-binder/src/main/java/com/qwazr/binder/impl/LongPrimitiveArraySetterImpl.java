...
final public class LongPrimitiveArraySetterImpl extends PrimitiveArraySetterAbstract {

	public LongPrimitiveArraySetterImpl(Field field) {
		super(field);
	}

	@Override
	public void fromString(String value, Object object) {
		set(object, new long[] { Long.parseLong(value) });
	}

	@Override
	final protected void fromNumber(Number number, Object object) {
		set(object, new long[] { number.longValue() });
	}

	@Override
	public void fromChar(Character value, Object object) {
		set(object, new long[] { (long) value });
	}

	@Override
	public void fromBoolean(Boolean value, Object object) {
		set(object, new long[] { (long) (value ? 1 : 0) });
	}
